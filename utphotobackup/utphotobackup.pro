...
# AppArmor profile
apparmor.files += $$PWD/harbour-owncloud-photobackup.apparmor
apparmor.path = /
...
# Desktop launcher
desktop.files += $$PWD/harbour-owncloud-photobackup.desktop
desktop.path = /

# Accounts description
accounts.files += $$PWD/harbour-owncloud-photobackup.accounts
accounts.path = /
...
INSTALLS += mfile apparmor runscript desktopicon desktop accounts
